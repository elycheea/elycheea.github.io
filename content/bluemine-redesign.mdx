...
intro: 'Rebuilding a 15-year-old intranet as a simple yet comprehensive space for consuming, monitoring, and sharing market information.'
stack: 'Angular, HTML, SCSS, JavaScript'
---
